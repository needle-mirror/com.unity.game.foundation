...
namespace UnityEngine.GameFoundation.Sample
{
    public class PrefabTutorial : MonoBehaviour
    {
        ...
        private readonly string[] m_TutorialSteps = 
        {
            ...
            "Now add a <b>Store</b> <i>prefab</i> of your choice to the <b>Body</b> <i>GameObject</i> under <b>Store UI</b> <i>GameObject</i>. In the Inspector window under <b>Store View</b> <i>component</i> select the store and category. You can see how when you switch them the Store display changes to match. (Note: The Store prefabs will only generate the Transaction Items at runtime.)",
            ...
            "For the game view to refresh and update to the new <b>Transaction Item</b>, you'll need to either toggle the selected game object in the hierarchy away and back to the Store <i>prefab</i>, or briefly change which category the prefab shows.",
