...
namespace UnityEngine.GameFoundation.Configs
{
    ...
    public abstract class CatalogItemConfig
    {
        ...
        /// </summary>
        /// <returns>
        ///     The newly create <see cref="BaseDetail" /> instance.
        /// </returns>
        internal void Compile()
        {
            ...
            runtimeItem.details = new Dictionary<Type, BaseDetail>(details.Count);
        ...
        internal void Link(CatalogBuilder builder)
        {
            ...
            foreach (var detailConfig in details)
            {
                ...
                runtimeItem.details.Add(detail.GetType(), detail);
            }
