...
namespace UnityEngine.GameFoundation
{
    ...
    class ItemLookup
    {
        ...
        /// <summary>
        ///     Remove the item with the given <paramref name="instanceId" />.
        /// </summary>
        /// <param name="instanceId">
        ///     Instance id of the item to remove.
        /// </param>
        /// <returns>
        ///     Return true if an item with the given <paramref name="instanceId" /> has been removed;
        ///     return false otherwise.
        /// </returns>
        internal bool Remove(int instanceId)
        {
            return m_Items.Remove(instanceId);
        }
        ...
        {
            return item != null && m_Items.Remove(item.instanceId);
        }
