...
namespace UnityEngine.GameFoundation
{
    ...
    {
        /// <summary>
        /// Get a <see cref="BaseTransaction"/> from its identifier.
        /// </summary>
        /// <param name="transactionKey">The identifier of the transaction
        ...
        public IAPTransaction FindIAPTransactionByProductId(string productId)
        {
            ...
            {
                if (transaction is IAPTransaction iapTransaction
