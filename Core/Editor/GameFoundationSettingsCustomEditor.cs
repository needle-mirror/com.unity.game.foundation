...
namespace UnityEditor.GameFoundation
{
    ...
    public class GameFoundationSettingsCustomEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            m_EnablePlayModeAnalytics = serializedObject.FindProperty(nameof(m_GameFoundationSettings.m_EnablePlayModeAnalytics));
            m_EnableEditorModeAnalytics = serializedObject.FindProperty(nameof(m_GameFoundationSettings.m_EnableEditorModeAnalytics));
