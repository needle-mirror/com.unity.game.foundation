...
namespace UnityEngine.GameFoundation.DataAccessLayers
{
    ...
    public interface ITransactionDataLayer
    {
        ...
        /// specified by its <paramref name="id"/>.
        /// </summary>
        /// <param name="id">Id of a <see cref="VirtualTransaction"/></param>
        /// <param name="itemIds">The list of items to use in the
        /// transaction.</param>
        ...
        /// and applies the rewards to the players account.
        /// </summary>
        /// <param name="id">Id of a <see cref="IAPTransaction"/></param>
        /// <param name="purchaseData">A JSON encoded string returned from a
        /// successful in app billing purchase.</param>
        /// <param name="purchaseDataSignature">A signature of the PurchaseData
        /// returned from a successful in app billing purchase</param>
        ...
        /// </summary>
        /// <param name="id">Id of a <see cref="IAPTransaction"/></param>
        /// <param name="receipt">Receipt data returned from the App Store as a
