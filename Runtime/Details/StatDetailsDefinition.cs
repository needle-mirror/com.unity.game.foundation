...
{
    /// <summary>
    /// Details definition to establish that item uses certain stats, and also to set default values for those stats.
    /// </summary>
    public class StatDetailsDefinition : BaseDetailsDefinition, ISerializationCallbackReceiver
    {
        /// <summary>
        /// Returns 'friendly' display name for this details definition.
        /// </summary>
        public override string DisplayName() { return "Stat Details"; }
        ...
        // internal constructor to prohibit developers instantiating StatDetailsDefinitions.
        internal StatDetailsDefinition()
        {
        }
        ...
        public int GetStatDefaultIntValue(string statDefinitionId)
        {
            return GetStatDefaultIntValue(Tools.StringToHash(statDefinitionId));
        }

        /// <summary>
        /// Get default value for specified stat.
        /// </summary>
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <returns>Default value for specified stat.</returns>
        public int GetStatDefaultIntValue(int statDefinitionIdHash)
        {
        ...
        /// <param name="statDefinitionId">The StatDefinition ID to address.</param>
        /// <returns>Default value for specified stat.</returns>
        public float GetStatDefaultFloatValue(string statDefinitionId)
        {
            return GetStatDefaultFloatValue(Tools.StringToHash(statDefinitionId));
        }
        ...
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <returns>Default value for specified stat.</returns>
        public float GetStatDefaultFloatValue(int statDefinitionIdHash)
        {
            if (m_StatDefaultFloatValues != null)
            {
                if (m_StatDefaultFloatValues.TryGetValue(statDefinitionIdHash, out float value))
                {
                    return value;
                }
            }
        ...
        /// <summary>
        /// Adds default value to StatDetailsDefinition for specified stat.
        /// This method throws if not in editor mode.
        /// </summary>
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <param name="value">The default value for the stat.</param>
        public void AddStatDefaultIntValue(int statDefinitionIdHash, int value)
        {
            ...
            m_StatDefaultIntValues[statDefinitionIdHash] = value;
        }

        /// <summary>
        /// Remove default value to StatDetailsDefinition for specified stat.
        /// This method throws if not in editor mode.
        /// </summary>
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <returns>True if the specified default stat was removed.</returns>
        public bool RemoveStatDefaultIntValue(int statDefinitionIdHash)
        {
            ...
            return m_StatDefaultIntValues.Remove(statDefinitionIdHash);
        }
        ...
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <param name="value">The default value for the stat.</param>
        public void AddStatDefaultFloatValue(int statDefinitionIdHash, float value)
        {
            ...
            m_StatDefaultFloatValues[statDefinitionIdHash] = value;
        }
        ...
        /// <param name="statDefinitionIdHash">The StatDefinition Hash ID to address.</param>
        /// <returns>True if the specified default stat was removed.</returns>
        public bool RemoveStatDefaultFloatValue(int statDefinitionIdHash)
        {
            ...
            return m_StatDefaultFloatValues.Remove(statDefinitionIdHash);
        }
