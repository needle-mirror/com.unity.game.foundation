...
namespace UnityEngine.GameFoundation.CatalogManagement
{
    ...
    /// <typeparam name="T2">The type of ItemDefinitions this CollectionDefinition uses.</typeparam>
    /// <inheritdoc/>
    public abstract class BaseCollectionDefinition<T1, T2> : GameItemDefinition
        ...
        where T2 : BaseItemDefinition<T1, T2>
    {
        ...
        public virtual bool AddDefaultItem(T2 defaultItem, int quantity = 0)
        {
            if (defaultItem == null)
                return false;
            
            return AddDefaultItem(new DefaultItem(defaultItem.id, quantity));
        }
