...
namespace UnityEngine.GameFoundation.CatalogManagement
{
    ...
    /// <typeparam name="T2">The type of ItemDefinitions this Catalog uses.</typeparam>
    public abstract class BaseCatalog<T1, T2> : ScriptableObject
        ...
        where T2 : BaseItemDefinition<T1, T2>
    {
        ...
        [SerializeField]
        private List<T2> m_ItemDefinitions = new List<T2>();

        /// <summary>
        /// A list of each type of ItemDefinition this Catalog can use.
        /// </summary>
        protected List<T2> itemDefinitions
        {
        ...
        public void GetItemDefinitions(List<T2> itemDefinitions)
        {
        ...
        public bool AddItemDefinition(T2 itemDefinition)
        {
        ...
        public bool RemoveItemDefinition(T2 itemDefinition)
        {
        ...
        public T2 GetItemDefinition(string itemDefinitionId)
        {
        ...
        /// <returns>Reference to the ItemDefinition requested.</returns>
        public T2 GetItemDefinition(int itemDefinitionHash)
        {
        ...
        public T2[] GetItemDefinitionsByCategory(string categoryId)
        {
        ...
        public void GetItemDefinitionsByCategory(string categoryId, List<T2> items)
        {
            if (items == null)
            {
                return;
        ...
        /// <returns>An array of ItemDefinitions that contain the given Category.</returns>
        public T2[] GetItemDefinitionsByCategory(int categoryHash)
        {
        ...
        /// <param name="categoryHash">The id hash of the CategoryDefinition we want to check for.</param>
        /// <param name="items">The list to clear and write matching items into.</param>
        public void GetItemDefinitionsByCategory(int categoryHash, List<T2> items)
        {
            if (items == null)
            {
                return;
        ...
        /// <returns>An array of ItemDefinitions that contain the given Category.</returns>
        public T2[] GetItemDefinitionsByCategory(CategoryDefinition category)
        {
            if (category == null)
            {
                return null;
        ...
        /// <param name="category">The Category we want to check for.</param>
        /// <param name="items">The list to clear and write matching items into.</param>
        public void GetItemDefinitionsByCategory(CategoryDefinition category, List<T2> items)
        {
            if (items == null)
            {
                return;
