...
namespace UnityEngine.GameFoundation.CatalogManagement
{
    ...
    /// </summary>
    /// <inheritdoc/>
    public class InventoryCatalog : BaseCatalog<InventoryDefinition, InventoryItemDefinition>
    {
        ...
        {
            if (GetCollectionDefinition(Tools.StringToHash(k_MainInventoryDefinitionId)) == null)
            {
            ...
            if (GetCollectionDefinition(Tools.StringToHash(k_WalletInventoryDefinitionId)) == null)
            {
