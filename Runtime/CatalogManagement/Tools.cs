...
namespace UnityEngine.GameFoundation.CatalogManagement
{
    internal static class Tools
    {
        ...
        {
            string gameFoundationPersistencePath = $"{Application.persistentDataPath}/" + k_GameFoundationPersistenceId;
            string gameFoundationPersistenceBackupPath = $"{Application.persistentDataPath}/" + k_GameFoundationPersistenceId + "_backup";
