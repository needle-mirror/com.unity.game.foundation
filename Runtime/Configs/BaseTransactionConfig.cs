namespace UnityEngine.GameFoundation.Configs
{
    ...
    {
        /// <summary>
        /// The configurator of the rewards.
        /// </summary>
        public TransactionExchangeDefinitionConfig rewards;

        /// <inheritdoc />
        protected internal sealed override BaseTransaction CompileItem()
        {
            var transaction = CompileGenericTransaction();
            transaction.rewards = rewards.Compile();
            return transaction;
        }
        ...
        {
            rewards.Link(builder, runtimeItem.rewards);
        ...
        where TRuntimeTransaction : BaseTransaction
    {
        ...
        /// </summary>
        /// <returns>The newly created <typeparamref name="TRuntimeTransaction"/>
        /// instance.</returns>
