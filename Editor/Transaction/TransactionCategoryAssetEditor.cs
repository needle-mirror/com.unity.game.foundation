...
{
    internal class TransactionCategoryAssetEditor : CollectionEditorBase<CategoryAsset>
    {
        private string m_CurrentCategoryId;

        public TransactionCategoryAssetEditor(string name) : base(name)
        {
        }
        ...
        public override void RefreshItems()
        {
            ...
            {
                GameFoundationDatabaseSettings.database.transactionCatalog.GetCategories(GetItems());
            }
        }
