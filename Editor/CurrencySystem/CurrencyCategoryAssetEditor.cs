...
{
    internal class CurrencyCategoryAssetEditor : CollectionEditorBase<CategoryAsset>
    {
        private string m_CurrentCategoryId;

        public CurrencyCategoryAssetEditor(string name) : base(name)
        {
        }
        ...
        public override void RefreshItems()
        {
            ...
            {
                GameFoundationDatabaseSettings.database.currencyCatalog.GetCategories(GetItems());
            }
        }
