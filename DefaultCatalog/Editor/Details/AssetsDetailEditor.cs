...
{
    [CustomEditor(typeof(AssetsDetailAsset))]
    class AssetsDetailAssetEditor : BaseDetailAssetEditor
    {
        SerializedProperty m_Names_SerializedProperty;
        SerializedProperty m_Values_SerializedProperty;

        AssetsDetailAsset m_TargetDefinition;
        readonly List<AssetsDetailListItem> m_ListItems = new List<AssetsDetailListItem>();
        ...
        void OnEnable()
        {
            ...
            m_TargetDefinition = targets[0] as AssetsDetailAsset;
            ...
            m_Names_SerializedProperty = serializedObject.FindProperty(nameof(m_TargetDefinition.m_Names));
            m_Values_SerializedProperty = serializedObject.FindProperty(nameof(m_TargetDefinition.m_Values));
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (var changeCheck = new EditorGUI.ChangeCheckScope())
            {
                using (new GUILayout.HorizontalScope(GameFoundationEditorStyles.tableViewToolbarStyle))
                {
                    ...
                    GUILayout.Label("Resource Path", GameFoundationEditorStyles.tableViewToolbarTextStyle);
                ...
                else
                {
                    ...
                    GUILayout.Label("no assets selected", GameFoundationEditorStyles.centeredGrayLabel);
                    EditorGUILayout.Space();
                }
                ...
                if (GUILayout.Button("+"))
                {
                    ...
                    newNameSerializedProperty.stringValue = AssetsDetailAsset.kNewAssetName;
                    ...
                    newValueSerializedProperty.stringValue = string.Empty;
                }
                    ...
                    for (var i = 0; i < m_Names_SerializedProperty.arraySize; i++)
                    {
                        if (string.IsNullOrEmpty(m_Names_SerializedProperty.GetArrayElementAtIndex(i).stringValue))
                        {
                            m_Names_SerializedProperty.GetArrayElementAtIndex(i).stringValue
                                = AssetsDetailAsset.kNewAssetName;
                        }
                    }
