                        ...
                        foreach (var detail in details)
                        {
                            ...
                            if (detailDefinitionEditor != null)
                            {
                                if (Attribute.GetCustomAttribute(
                                    ...
                                    is ObsoleteAttribute obsoleteAttribute)
                                {
